...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutParam.addWidget(self.label_7, 5, 0, 1, 1)

        self.label_8 = QtWidgets.QLabel(self.gridLayoutWidget_3)
        self.label_8.setObjectName("label_8")
        self.gridLayoutParam.addWidget(self.label_8, 6, 0, 1, 1)

        self.comboCamera = QtWidgets.QComboBox(self.gridLayoutWidget_3)
        self.comboCamera.setObjectName("comboCamera")
        self.comboCamera.addItems(["Camera 1", "Camera 2","Camera 4","Camera 5","..."])  
        self.gridLayoutParam.addWidget(self.comboCamera, 5, 1, 1, 1)

        self.edtInput = QtWidgets.QLineEdit(self.gridLayoutWidget_3)
        self.edtInput.setObjectName("edtInput")
        self.gridLayoutParam.addWidget(self.edtInput, 6, 1, 1, 1)

        self.bnGetParam = QtWidgets.QPushButton(self.gridLayoutWidget_3)
        self.bnGetParam.setObjectName("bnGetParam")
        self.gridLayoutParam.addWidget(self.bnGetParam, 7, 0, 1, 1)

        self.bnSetParam = QtWidgets.QPushButton(self.gridLayoutWidget_3)
        self.bnSetParam.setObjectName("bnSetParam")
        self.gridLayoutParam.addWidget(self.bnSetParam, 7, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "Option"))
