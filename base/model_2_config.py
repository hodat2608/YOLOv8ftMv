...
class Model_Camera_2(Base,MySQL_Connection,PLC_Connection):
    ...
    def read_plc_value_from_file(self):
        with open(r"C:\Users\CCSX009\Documents\ultralytics-main\var_plc2.txt", 'r') as file:
            content = file.read()
            parts = content.split('=')
            if len(parts) == 2:
    ...
    def write_plc_value_to_file(self):
        with open(r"C:\Users\CCSX009\Documents\ultralytics-main\var_plc2.txt", 'w') as file:
    ...
    def extract_fh(self):
        ...
        height = 800
        t1 = time.time()
        image_paths = glob.glob(f"C:/Users/CCSX009/Documents/yolov5/test_image/camera2/*.jpg")
