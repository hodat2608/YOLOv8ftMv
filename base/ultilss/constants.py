...
class setupTools:
    ...
    def _get_lc_item(self):
        _data_id_lists = {
            1: ITEM_1, 2: ITEM_2, 3: ITEM_3, 4: ITEM_4, 5: ITEM_5, 6: ITEM_6,
            7: ITEM_7, 8: ITEM_8, 9: ITEM_9, 10: ITEM_10, 11: ITEM_11, 12: ITEM_12,
            13: ITEM_13, 14: ITEM_14, 15: ITEM_15, 16: ITEM_16, 17: ITEM_17, 
            18: ITEM_18, 19: ITEM_19, 20: ITEM_20, 21: ITEM_21, 22: ITEM_22,
    ...
    def _get_lc_state(self,id,x,y,x_c,y_c):
        if (
            ...
            return [id, [x, y], [x_c, y_c], [False]]
        else:
            return [id, [x, y], [x_c, y_c], [True]]
   
    # @staticmethod
    def _get_local_objs(self, a, obj_x, obj_y):
    ...
    # @staticmethod
    def _return_localtion(self, id, obj_x, obj_y, x, y):
        if (
            obj_x < x - UNIT
            or obj_x > x + UNIT
            or obj_y < y - UNIT
