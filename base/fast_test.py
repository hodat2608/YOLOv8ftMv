...
class ConnectionStatusGUI(tk.Tk):
    def __init__(self):
        ...
        # Tạo nhãn và nút reconnect cho từng kết nối
        ...
        # Load hình ảnh cho dấu tích xanh, dấu X đỏ, và nút reconnect
        

        # Thiết lập ban đầu cho trạng thái kết nối
        self.check_connections()

    def create_connection_row(self, label_text, reconnect_command, row):
        """Tạo hàng cho trạng thái kết nối và nút reconnect."""
    ...
    def check_camera_connection(self):
        ...
        #     )
        #     return self.request_pylon.connect()
        # except:
            return False
